<div class="row space-below">
    <div class="span12">
        ...
        <ul class="nav nav-tabs" id="admin_tabs">
            <li><a href="#tab_summary" data-toggle="tab" data-uri="{$base_uri}admin/tab/summary/">Summary</a></li>

            <li><a href="#tab_services" data-toggle="tab" data-uri="{$base_uri}admin/tab/services/">Services</a></li>

            <li><a href="#tab_sites" data-toggle="tab" data-uri="{$base_uri}admin/tab/sites/">Sites</a></li>

            <li><a href="#tab_incidents" data-toggle="tab" data-uri="{$base_uri}admin/tab/incidents/">Incidents</a></li>

            <li><a href="#tab_users" data-toggle="tab" data-uri="{$base_uri}admin/tab/users/">Users</a></li>

            <li><a href="#tab_settings" data-toggle="tab" data-uri="{$base_uri}admin/tab/settings/">Settings</a></li>
        </ul>
    </div><!-- /span12 -->
</div><!-- /row -->

<div id="admin-tab-content" class="tab-content">
    <!--tab-content(container for all main div content on page -->

    <div class="tab-pane {if $tab == 'summary'}active{/if}" id="tab_summary">
        <!--Toggled Div to hide admin content -->
    ...
    <div class="tab-pane {if $tab == 'services'}active{/if}" id="tab_services">
        <!--Toggled Div to hide services content -->
    ...
    <div class="tab-pane {if $tab == 'sites'}active{/if}" id="tab_sites">
        <!--Toggled Div to hide sites content -->
                ...
                <form class="form-horizontal" id="admin_quicksettings" method="post" action="{$base_uri}admin/tab/settings/do/save-settings/">
                    ...
                    <fieldset>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input id="admin_quicksettings_debug_displayexceptions" name="debug_displayexceptions" type="checkbox" value="1">
                            </div>
                        </div><!-- /control-group -->
...
<div id="confirm_delete" class="modal hide fade">
    ...
    <div class="modal-footer">
        <button class="btn btn-danger" id="confirm_delete_do">Delete</button> <button class="btn btn-secondary" id="confirm_delete_cancel">Cancel</button>
    </div>
